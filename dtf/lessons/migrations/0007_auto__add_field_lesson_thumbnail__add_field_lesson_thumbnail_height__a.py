...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.thumbnail'
        db.add_column(u'lessons_lesson', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lesson.thumbnail_height'
        db.add_column(u'lessons_lesson', 'thumbnail_height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Lesson.thumbnail_width'
        db.add_column(u'lessons_lesson', 'thumbnail_width',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.thumbnail'
        db.delete_column(u'lessons_lesson', 'thumbnail')

        # Deleting field 'Lesson.thumbnail_height'
        db.delete_column(u'lessons_lesson', 'thumbnail_height')

        # Deleting field 'Lesson.thumbnail_width'
        db.delete_column(u'lessons_lesson', 'thumbnail_width')
