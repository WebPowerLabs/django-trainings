...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.public_start'
        db.add_column(u'lessons_lesson', 'public_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Lesson.public_expire'
        db.add_column(u'lessons_lesson', 'public_expire',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.public_start'
        db.delete_column(u'lessons_lesson', 'public_start')

        # Deleting field 'Lesson.public_expire'
        db.delete_column(u'lessons_lesson', 'public_expire')
