...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookGroup.thumbnail'
        db.add_column(u'facebook_groups_facebookgroup', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookGroup.thumbnail_height'
        db.add_column(u'facebook_groups_facebookgroup', 'thumbnail_height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FacebookGroup.thumbnail_width'
        db.add_column(u'facebook_groups_facebookgroup', 'thumbnail_width',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FacebookGroup.cover'
        db.add_column(u'facebook_groups_facebookgroup', 'cover',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacebookGroup.cover_height'
        db.add_column(u'facebook_groups_facebookgroup', 'cover_height',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'FacebookGroup.cover_width'
        db.add_column(u'facebook_groups_facebookgroup', 'cover_width',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'FacebookGroup.pinned_comment'
        db.alter_column(u'facebook_groups_facebookgroup', 'pinned_comment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dtf_comments.DTFComment'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'FacebookGroup.thumbnail'
        db.delete_column(u'facebook_groups_facebookgroup', 'thumbnail')

        # Deleting field 'FacebookGroup.thumbnail_height'
        db.delete_column(u'facebook_groups_facebookgroup', 'thumbnail_height')

        # Deleting field 'FacebookGroup.thumbnail_width'
        db.delete_column(u'facebook_groups_facebookgroup', 'thumbnail_width')

        # Deleting field 'FacebookGroup.cover'
        db.delete_column(u'facebook_groups_facebookgroup', 'cover')

        # Deleting field 'FacebookGroup.cover_height'
        db.delete_column(u'facebook_groups_facebookgroup', 'cover_height')

        # Deleting field 'FacebookGroup.cover_width'
        db.delete_column(u'facebook_groups_facebookgroup', 'cover_width')


        # Changing field 'FacebookGroup.pinned_comment'
        db.alter_column(u'facebook_groups_facebookgroup', 'pinned_comment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_comments.Comment'], unique=True, null=True))
