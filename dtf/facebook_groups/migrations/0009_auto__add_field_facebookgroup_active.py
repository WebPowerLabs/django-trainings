...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookGroup.active'
        db.add_column(u'facebook_groups_facebookgroup', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookGroup.active'
        db.delete_column(u'facebook_groups_facebookgroup', 'active')
