...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookGroup.pinned_comment'
        db.add_column(u'facebook_groups_facebookgroup', 'pinned_comment',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_comments.Comment'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookGroup.pinned_comment'
        db.delete_column(u'facebook_groups_facebookgroup', 'pinned_comment_id')
    ...
    models = {
        ...
        u'facebook_groups.facebookgroup': {
            ...
            'pinned_comment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_comments.Comment']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
