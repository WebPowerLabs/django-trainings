...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JournalQuestion.position'
        db.add_column(u'journals_journalquestion', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JournalQuestion.position'
        db.delete_column(u'journals_journalquestion', 'position')
