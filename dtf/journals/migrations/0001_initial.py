...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'journals_journal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.User'], unique=True)),
        ))
        db.send_create_signal(u'journals', ['Journal'])

        # Adding model 'JournalQuestion'
        db.create_table(u'journals_journalquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('type', self.gf('django.db.models.fields.CharField')(default='char', max_length=4)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'journals', ['JournalQuestion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'JournalQuestion'
        db.delete_table(u'journals_journalquestion')
