...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field journals on 'Package'
        db.delete_table(db.shorten_name(u'packages_package_journals'))


    def backwards(self, orm):
        # Adding M2M table for field journals on 'Package'
        m2m_table_name = db.shorten_name(u'packages_package_journals')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('package', models.ForeignKey(orm[u'packages.package'], null=False)),
            ('journalquestion', models.ForeignKey(orm[u'journals.journalquestion'], null=False))
        ))
        db.create_unique(m2m_table_name, ['package_id', 'journalquestion_id'])
