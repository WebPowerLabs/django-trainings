...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfusionsoftTag.group_category_id'
        db.alter_column(u'packages_infusionsofttag', 'group_category_id', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InfusionsoftTag.group_description'
        db.alter_column(u'packages_infusionsofttag', 'group_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InfusionsoftTag.group_name'
        db.alter_column(u'packages_infusionsofttag', 'group_name', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'InfusionsoftTag.group_category_id'
        db.alter_column(u'packages_infusionsofttag', 'group_category_id', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'InfusionsoftTag.group_description'
        db.alter_column(u'packages_infusionsofttag', 'group_description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'InfusionsoftTag.group_name'
        db.alter_column(u'packages_infusionsofttag', 'group_name', self.gf('django.db.models.fields.TextField')(default=''))
