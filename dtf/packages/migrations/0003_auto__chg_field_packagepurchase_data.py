...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'packages_packagepurchase', 'data', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'PackagePurchase.data'
        db.alter_column(u'packages_packagepurchase', 'data', self.gf('django.db.models.fields.TextField')())
