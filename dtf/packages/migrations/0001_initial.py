...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'packages_infusionsoftpackage', (
            ...
            ('subscription_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('product_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cycle', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('frequency', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('pre_authorize_amount', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('prorate', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('plan_price', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('product_price', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('action_set_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('purchase_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        ...
        db.create_table(u'packages_infusionsofttag', (
            ...
            ('group_category_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('group_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'force_progess': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'lessons.lesson': {
            ...
            'public_expire': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'public_start': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'packages.infusionsofttag': {
            ...
            'group_category_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'group_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'group_name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
