...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InfusionsoftPackage.purchase_url'
        db.add_column(u'packages_infusionsoftpackage', 'purchase_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InfusionsoftPackage.purchase_url'
        db.delete_column(u'packages_infusionsoftpackage', 'purchase_url')
