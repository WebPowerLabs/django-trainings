...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackagePurchase.data'
        db.alter_column(u'packages_packagepurchase', 'data', self.gf('jsonfield.fields.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'PackagePurchase.data'
        db.alter_column(u'packages_packagepurchase', 'data', self.gf('jsonfield.fields.JSONField')(default=''))
