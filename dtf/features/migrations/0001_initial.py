...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'features_feature', (
            ...
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='features', to=orm['django_comments.Comment'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_feature', to=orm['contenttypes.ContentType'])),
    ...
    models = {
        ...
        u'features.feature': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'features'", 'to': u"orm['django_comments.Comment']"}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'content_type_set_for_feature'", 'to': u"orm['contenttypes.ContentType']"}),
