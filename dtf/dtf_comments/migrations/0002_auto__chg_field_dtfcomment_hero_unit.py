...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dtf_comments_dtfcomment', 'hero_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Content'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DTFComment.hero_unit'
        raise RuntimeError("Cannot reverse this migration. 'DTFComment.hero_unit' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'DTFComment.hero_unit'
        db.alter_column(u'dtf_comments_dtfcomment', 'hero_unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Content']))
