...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.infusionsoft_uid'
        db.add_column(u'users_user', 'infusionsoft_uid',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.infusionsoft_uid'
        db.delete_column(u'users_user', 'infusionsoft_uid')
