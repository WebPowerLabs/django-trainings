...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtfarAccessCondition'
        db.create_table(u'etfars_etfaraccesscondition', (
        ...
        db.send_create_signal(u'etfars', ['EtfarAccessCondition'])


    def backwards(self, orm):
        # Deleting model 'EtfarAccessCondition'
        db.delete_table(u'etfars_etfaraccesscondition')
    ...
    models = {
        ...
        u'etfars.etfaraccesscondition': {
            'Meta': {'object_name': 'EtfarAccessCondition'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'journals.journalquestion': {
            'Meta': {'ordering': "('position',)", 'object_name': 'JournalQuestion'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
